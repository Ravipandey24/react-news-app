...
export function LoadingCards({ count }) {
  return (
    <div className="grid gap-4 grid-cols-3 px-4 py-3">
      {Array(count)
        .fill(0)
        .map((_, id) => (
          <div
...
export function LoadingImages({ count }){
  return (
    <>
      { Array(count).fill(0).map((_, id) => (
        <div key={'image_load' + id} role="status" className="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex md:items-center">
